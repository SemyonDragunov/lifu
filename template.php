 ...
 */
function lifu_theme($existing, $type, $theme, $path) {
  $theme = array();
 ...
 */
function lifu_preprocess_page(&$variables) {
  global $user;
 ...
 */
function lifu_preprocess_html(&$variables) {
  global $user;
 ...
 */
function lifu_preprocess_block(&$variables, $hook) {
 ...
 * For footer.tpl.php
 */
function lifu_preprocess_footer(&$variables) {
 ...
 * For header.tpl.php
 */
function lifu_preprocess_header(&$variables) {
 ...
 * Login and a password recovery pages.
 */
if (theme_get_setting('lifu_login_page')) {
  function lifu_form_user_login_block_alter(&$form, &$form_state) {
  ...
  function lifu_form_user_login_alter(&$form, &$form_state) {
    $form['name']['#title_display'] = 'invisible';
    $form['name']['#attributes'] = array('placeholder' => 'Логин');
  ...
  function lifu_form_user_pass_alter(&$form, &$form_state) {
    $form['name']['#title_display'] = 'invisible';
 ...
 */
function lifu_process_html(&$variables) {
 ...
 */
function lifu_process_page(&$variables, $hook) {
  if (module_exists('color')) {
